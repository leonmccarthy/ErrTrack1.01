...
<div class="bg-holder" style="background-image:url(imports/user/assets/img/illustrations/contact-us-bg.png);background-position:left bottom;background-size:auto;">
</div>
<!--/.bg-holder-->

<div class="bg-holder" style="background-image:url(imports/user/assets/img/gallery/contact-bg.png);background-position:center right ;background-size:contain;">
</div>
<!--/.bg-holder-->
...
<div class="container">
            ...
            <form method="POST" action="{{ url("/contactus") }}" enctype="multipart/form-data">
                ...
                @if (Auth::user())
                    <div class="row mb-3 input-group-icon">
                        ...
                        <div class="col-sm-12">
                        <input class="form-control rounded-pill border-white input-box" id="inputName" type="text" placeholder="Write your name" value="{{ Auth::user()->name }}" disabled/>
                    ...
                    <div class="row mb-3 input-group-icon">
                        ...
                        <div class="col-sm-12">
                        <input class="form-control rounded-pill border-white input-box" id="inputEmail3" type="email" placeholder="Write your email" value="{{ Auth::user()->email }}" disabled/>
                    ...
                    <div class="row mb-3 input-group-text-icon">
                        ...
                        <div class="col-sm-12">
                        <textarea name="message" class="form-control rounded-3 border-white input-box" id="floatingTextarea2" placeholder="Write your message" style="height: 150px" required></textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                        <div class="d-grid">
                            <button class="btn hover-top btn-glow btn-outline-klean rounded-pill" type="submit">Submit </button>
                        </div>
                        </div>
                    </div>
                ...
                @else
                    ...
                    <div class="row mb-3 input-group-icon">
                        <label class="col-sm-2 col-form-label visually-hidden" for="inputName">Name</label>
                        <div class="col-sm-12">
                        <input name="name" class="form-control rounded-pill border-white input-box" id="inputName" type="text" placeholder="Write your name" required/>
                        <svg class="bi bi-person-fill input-box-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path>
                        </svg>
                        </div>
                    ...
                    <div class="row mb-3 input-group-icon">
                        <label class="col-sm-2 col-form-label visually-hidden" for="inputEmail3">Email</label>
                        <div class="col-sm-12">
                        <input name="email" class="form-control rounded-pill border-white input-box" id="inputEmail3" type="email" placeholder="Write your email" required/>
                        <svg class="bi bi-envelope-fill input-box-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"></path>
                        </svg>
                        </div>
    ...
    <div class="col-lg-5 offset-lg-1">
        ...
        <div class="flex-1 ms-3">
            ...
            <p>Ratna,<br />Bamburi, Kisauni, <br />Mombasa</p>
        </div>
        </div>
    </div>
    </div>
