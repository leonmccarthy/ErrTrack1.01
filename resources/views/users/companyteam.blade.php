          ...
          <div class="row flex-center g-0">
            @foreach ($admin as $admin)
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="shadow-square-right"><img class="team-card-1" src="/{{ $admin->my_photo }}" width="200" height="150" alt="..." /></div>
            ...
            @foreach ($developer as $developer)
              <div class="col-sm-6 col-lg-3 text-center">
                <div class=" shadow-square-right"><img class="team-card-2" src="/{{ $developer->my_photo }}" width="200" height="150" alt="..." /></div>
            ...
            @foreach ($tester as $tester)
              <div class="col-sm-6 col-lg-3 text-center">
                <div class="shadow-square-right"><img class="team-card-3" src="/{{ $tester->my_photo }}" width="200" height="150" alt="..." /></div>
