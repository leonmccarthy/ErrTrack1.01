...
<head>
  ...
  <title>Developer | Edit Total Completion Steps</title>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('/edit-steps-to-complete-action', $assignedErrorToBeEdited->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-pill" name="project_name" id="project_name" value="{{  $assignedErrorToBeEdited->project_name }}" required disabled>
                      </div>
                      <div class="form-group">
